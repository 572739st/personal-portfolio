var kaboom = (() => {
    ...
    var et = (t, e, o) => (e in t ? Qe(t, e, { enumerable: !0, configurable: !0, writable: !0, value: o }) : (t[e] = o)),
        le = (t, e) => {
    ...
    function ee(t) {
        return {
            ...
            mult(e) {
                let o = [];
                for (let i = 0; i < 4; i++) for (let m = 0; m < 4; m++) o[i * 4 + m] = this.m[0 * 4 + m] * e.m[i * 4 + 0] + this.m[1 * 4 + m] * e.m[i * 4 + 1] + this.m[2 * 4 + m] * e.m[i * 4 + 2] + this.m[3 * 4 + m] * e.m[i * 4 + 3];
                return ee(o);
            },
            multVec4(e) {
                return {
    ...
    function Xe(t) {
        return {
            seed: t,
            gen(...e) {
                if (e.length === 0) return (this.seed = (rn * this.seed + sn) % ut), this.seed / ut;
                if (e.length === 1) {
    ...
    function yt(t, e) {
        let o = (() => {
            ...
            i = (() => {
                var K;
                let h = A(We, Ke),
                    x = v(new ImageData(new Uint8ClampedArray([255, 255, 255, 255]), 1, 1)),
...
`)
        ...
        function $(h, x, b = i.defTex, L = i.defProg, z = {}) {
            (b = b != null ? b : i.defTex),
                ...
                (b !== i.curTex || L !== i.curProg || !$e(i.curUniform, z) || i.vqueue.length + h.length * Ie > Ne || i.iqueue.length + x.length > Ne) && k(),
                (i.curTex = b),
                (i.curProg = L),
                (i.curUniform = z);
        ...
        r(k, "flush");
        function I() {
            t.clear(t.COLOR_BUFFER_BIT), e.clearColor || q({ width: he(), height: pe(), quad: oe(0, 0, (he() * be()) / bt, (pe() * be()) / bt), tex: i.bgTex }), (i.drawCalls = 0), (i.transformStack = []), (i.transform = ee());
        }
        r(I, "frameStart");
        function j() {
...
` && (ge[ge.length - 1].push(ie), (F += P)),
        ...
        r(ue, "drawText");
        function ce(h) {
            for (let x of h.chars) q({ tex: x.tex, width: x.tex.width * x.quad.w, height: x.tex.height * x.quad.h, pos: x.pos, scale: x.scale, color: x.color, quad: x.quad, origin: "center", z: x.z });
        }
        r(ce, "drawFmtText");
        function he() {
...
`);
    ...
    function wt(t = {}) {
        ...
        let e = {
            ...
            o = { ArrowLeft: "left", ArrowRight: "right", ArrowUp: "up", ArrowDown: "down", " ": "space" },
            i = ["space", "left", "right", "up", "down", "tab", "f1", "f2", "f3", "f4", "f5", "f6", "f7", "f8", "f9", "f10", "f11"];
        ...
        let v = e.canvas.getContext("webgl", { antialias: !0, depth: !0, stencil: !0, alpha: !0, preserveDrawingBuffer: !0 });
        ...
        function H(E) {
            let O = r((te) => {
                ...
                (e.realTime = ne),
                    e.skipTime ||
                        ((e.dt = ue), (e.time += e.dt), e.fpsBuf.push(1 / e.dt), (e.fpsTimer += e.dt), e.fpsTimer >= 1 && ((e.fpsTimer = 0), (e.fps = Math.round(e.fpsBuf.reduce((ce, he) => ce + he) / e.fpsBuf.length)), (e.fpsBuf = []))),
                    (e.skipTime = !1),
                    E();
                for (let ce in e.keyStates) e.keyStates[ce] = gt(e.keyStates[ce]);
                (e.mouseState = gt(e.mouseState)), (e.charInputted = []), e.stopped || (e.loopID = requestAnimationFrame(O));
            }, "frame");
        ...
        return (
            r(M, "quit"),
            { gl: v, mousePos: A, keyDown: T, keyPressed: I, keyPressedRep: j, keyReleased: w, mouseDown: $, mouseClicked: R, mouseReleased: k, charInputted: S, cursor: y, dt: U, time: B, fps: _, screenshot: G, run: H, quit: M }
        );
    }
    var vt = fe(() => {
        xe();
    ...
    function St() {
        ...
        function e(m) {
            return m !== void 0 && (t.gainNode.gain.value = ae(m, Rt, Tt)), t.gainNode.gain.value;
        }
        r(e, "volume");
    ...
    function Dt(t, e, o = {}) {
        ...
        return r(j, "defFont"), R(Se, Ct, 8, 8), { loadRoot: A, loadSprite: $, loadSound: I, loadFont: R, loadShader: k, loadProgress: v, addLoader: m, defFont: j, sprites: i.sprites, fonts: i.fonts, sounds: i.sounds, shaders: i.shaders };
    }
    var mn,
        Se,
        Pt = fe(() => {
    ...
    var pn = nn((Un, Mt) => {
        ...
        Lt();
        Gt();
        Mt.exports = (t = { width: 640, height: 480, scale: 1, fullscreen: !1, debug: !1, crisp: !1, canvas: null, connect: null, logMax: 8, root: document.body }) => {
            let e = wt({ width: t.width, height: t.height, scale: t.scale, fullscreen: t.fullscreen, crisp: t.crisp, canvas: t.canvas, root: t.root }),
                o = yt(e.gl, { clearColor: t.clearColor ? Y(t.clearColor) : void 0, scale: t.scale, texFilter: t.texFilter }),
                i = St(),
                m = Dt(o, i, {
                    errHandler: (s) => {
                        v.error(s);
            ...
            function G(s, n) {
                _.scenes[s] = {
                    init: n,
                    initialized: !1,
                    events: { add: [], update: [], draw: [], destroy: [], keyDown: [], keyPress: [], keyPressRep: [], keyRelease: [], mouseClick: [], mouseRelease: [], mouseDown: [], charInput: [] },
                    action: [],
                    render: [],
                    objs: new Map(),
                    lastObjID: 0,
                    timers: {},
                    lastTimerID: 0,
                    cam: { pos: f(o.width() / 2, o.height() / 2), scale: f(1, 1), angle: 0, shake: 0, mpos: f(0), matrix: ee() },
                    layers: {},
                    defLayer: null,
                    gravity: U,
                    data: {},
            ...
            function se(s) {
                let n = y(),
                    a = [...n.objs.values()].sort((d, u) => {
                        var l, g, D, N, Q, de;
                        let p = (D = (g = n.layers[(l = d.layer) != null ? l : n.defLayer]) == null ? void 0 : g.order) != null ? D : 0,
                            c = (de = (Q = n.layers[(N = u.layer) != null ? N : n.defLayer]) == null ? void 0 : Q.order) != null ? de : 0;
                        return p - c;
                    });
            ...
            function Bt(s, n = {}) {
                ...
                return {
                    ...
                    changeSprite(l) {
                        ...
                        let g = le({}, a.frames[0]);
                        n.quad && ((g.x += n.quad.x * g.w), (g.y += n.quad.y * g.h), (g.w *= n.quad.w), (g.h *= n.quad.h)),
                ...
                return {
                    ...
                    add() {
                        ...
                        if (!this.area && !a.noArea) {
                            let c = y(),
                                ...
                                g = o.fmtText(this.text + "", l, { pos: this.pos, scale: this.scale, rot: this.angle, size: this.textSize, origin: this.origin, color: this.color, width: a.width });
                    ...
                    draw() {
                        ...
                        let d = y(),
                            ...
                            p = o.fmtText(this.text + "", u, { pos: this.pos, scale: this.scale, rot: this.angle, size: this.textSize, origin: this.origin, color: this.color, width: a.width });
...
function drawScore(score) {
    ...
    const textSize = 24; // Adjust the text size as needed
    const font = 'Arial'; // Adjust the font as needed
    ...
    const xPos = 10 + (numDigits - 1) * 10; // Adjust the multiplier as needed
